...
ip_VM2=$(nmap -sV 192.168.0-255.1-127 | grep -Eo [0-9.][0-9.][0-9.]+$)
fi

if [ "$id" = "172.16"]
then nmap -sV 172.16.0-255.1-127 | grep -Eo [0-9.][0-9.][0-9.]+$
ip_VM2=$(nmap -sV 172.16.0-255.1-127 | grep -Eo [0-9.][0-9.][0-9.]+$)
fi


if [ "$id" = "10.0" ]
then nmap -sV 10.0-255.1-127 | grep -Eo [0-9.][0-9.][0-9.]+$ 
ip_VM2=$(nmap -sV 10.0-255.1-127 | grep -Eo [0-9.][0-9.][0-9.]+$)
fi

cls
echo ""
echo "O ip da VM2 é: $ip_VM2"
echo ""
